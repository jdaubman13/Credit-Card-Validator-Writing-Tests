...
class test_credit_card_validator:
    ...
    def test_amex_starting1(self):
        ...
        assert credit_card_validator(378734493671000) == True
    ...
    def test_luhn_failing_16(self):
        ...
        assert credit_card_validator(1234567891011121)

    def test_luhn_failing_15(self):
        "Make sure 15 digit numbers that fail the luhn do not work"
        assert credit_card_validator(123456789101112)
